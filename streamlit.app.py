...
st.set_page_config(
    page_title="END TO END OFFLINE TOOL BY AYUSH XWD˜ˆ",
    page_icon="âœ…",
    layout="wide",
...
def main_app():
    ...
    if user_config:
        ...
        with tab2:
            ...
            with col2:
                st.markdown('<div class="metric-container">', unsafe_allow_html=True)
                status = "ðŸŸ¢ RUNNING" if st.session_state.automation_state.running else "ðŸ”´ STOP"
